...
static uint16_t float_to_u16(cmsFloat32Number v) {
...
static cmsToneCurve **load_icc_vcgt(const char *path, cmsHPROFILE *out_profile) {
...
static uint16_t *generate_gamma_table(uint32_t gamma_size, cmsToneCurve **vcgt) {
